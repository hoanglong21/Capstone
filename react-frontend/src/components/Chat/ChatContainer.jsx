...
import { getDatabase, ref, child, push, update, onChildAdded, remove, onChildRemoved } from "firebase/database";
...
const ChatContainer = () => {
  ...
  useEffect(() => {
    ...
    onChildRemoved(getData, (data) => {
      ...
      console.log(`The message with ID ${data.key} was removed:`, deletedMessage);
      setMessages(messages => messages.filter((message) => message.key !== data.key))
    });
  }, [])  
