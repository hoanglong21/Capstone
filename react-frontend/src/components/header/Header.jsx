  ...
  return (
    <header className="px-4 border-bottom">
      <nav className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start navbar navbar-expand-sm">
        ...
        >
          <img className="bi me-5" src={logo} alt="logo" width="60rem" />
        </a>
        ...
        <div className="d-flex align-items-center">
          ...
          <div className="dropdown d-inline-flex">
            <button
              ...
              aria-expanded="false"
            >
              <AddCircleIcon className="icon-primary" size="3.5rem" />
            </button>
            <ul className="dropdown-menu dropdown-menu-end p-2">
              <li>
                <a
                  ...
                  aria-expanded="true"
                >
                  <span className="align-middle fw-semibold">Study Set</span>
                </a>
                <ul
              ...
              {(!userInfo || userInfo?.role !== "ROLE_LEARNER") && (
                <li>
                  <button
                    className="dropdown-item py-2 px-2"
                    type="button"
                  ...
                  >
                    <span className="align-middle fw-semibold">Class</span>
                  </button>
                  <button
          ...
          {userToken ? (
            <div>
              {/* Notify */}
              <div id="bell" className="dropdown d-inline-flex me-2">
                <button
                ...
                <ul className="dropdown-menu dropdown-menu-end p-2">
                  ...
                  <li>
                    <button
                      ...
                      type="button"
                      onClick={() => {
                        navigate("/library/achievements");
                      }}
                    >
                      <AchievementIcon className="me-3" strokeWidth="1.65" />
