            ...
            <div className="set-item mb-3">
              <Link to={`/`}>
                <div className="set-body row mb-2">
                  <div className="term-count col-1">Member</div>
                  <div className="set-author col d-flex " href="#">
                    ...
                    <span className="author-username ms-2">Creator</span>
                  </div>
                </div>
                <div className="row">
                  ...
                  <div className="col d-flex align-items-center">
                    <p className="set-description m-0">Class Description</p>
                  </div>
                </div>
              </Link>
            </div>
