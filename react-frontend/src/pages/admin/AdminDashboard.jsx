                        ...
                        <div className="col-lg-6 mb-4">
                            <div className="card shadow mb-4">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>
                                        In the future, the Nihongo Level Up
                                        development team will release more new
                                        features for users to help people have a
                                        better experience when using our
                                        website. Hope to work with you all.
                                    </p>
                                </div>
                            </div>
                        </div>
