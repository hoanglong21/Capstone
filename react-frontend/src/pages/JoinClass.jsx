        ...
        <div className="joinClass">
          <div className="joinClass__wrapper">
            <div className="joinClass__wraper2">
             <Link to="/" className="closeJoin">&times;</Link>
          ...
          <div className="joinClass__form">
            ...
            <div className="joinClass__loginInfo">
              <div className="joinClass__classLeft">
                <img src={'https://reactjs.org/logo-og.png'} alt="" style={{ width: '40px', }}/>
          ...
          <div className="joinClass__form">
            ...
            <div className="joinClass__loginInfo">
              <input type="text" placeholder="Class Code" value={classCode}
                onChange={(e) => setClassCode(e.target.value)}
                error={error} helperText={error && "No class was found"}/>
            </div>
          </div>
          <div className="note">
            <div
              style={{ fontSize: "1rem", fontWeight: 'bold', color: "#3C4043"}}
              className="joinClass__formText"
            >
              How to sign in with the class code: 
              <li>Using a licensed account </li>
              <li>Using the 5-7 letter or number class code, no spaces or symbols</li>
            </div>
          </div>
        </div>
  );
