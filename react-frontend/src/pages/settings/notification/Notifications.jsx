...
const Notifications = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const settings = (await UserSettingService.customSettings(userInfo.id))
          .data;
        // study reminder
        setStudyReminder({
          user: {
  ...
  return (
    <div className="noti-settings">
      ...
      <div className="mt-4">
        {/* successMess message */}
        {successMess && (
          <div className="alert alert-success col-12 mb-0" role="alert">
            {t("msg44")}!
          </div>
        )}
        <fieldset className="notification_formContainer form-check mb-3 ps-0">
          ...
          <div className="mt-2 notification_formTime">
            <label htmlFor="studyReminderTime" className="form-label">
              {t("timeDay")}:
            </label>
            <input
              type="time"
              ...
              disabled={!isStudyReminder || userInfo?.status === "pending"}
              onChange={(event) => {
                setStudyReminder({
                  ...studyReminder,
        ...
        <fieldset className="notification_formContainer form-check mb-3 ps-0">
          ...
          <div className="mb-3">
            ...
            />
            <label className="form-check-label" htmlFor="assignmentReminder">
              {t("assRemind")}
            </label>
            <div className="mt-2">
              <div className="row d-flex align-items-center">
                ...
                <div className="remind-noti-col-10 notification_formTime">
                  <input
                    ...
                    type="number"
                    disabled={
                      !isAssignDueDate || userInfo?.status === "pending"
                    }
          ...
          <div>
            ...
            />
            <label className="form-check-label" htmlFor="testReminder">
              {t("testR")}
            </label>
            <div className="mt-2">
              <div className="row d-flex align-items-center">
                ...
                <div className="remind-noti-col-10 notification_formTime">
                  <input
                    ...
                    disabled={!isTestDueDate || userInfo?.status === "pending"}
        ...
        <fieldset className="form-check notification_formContainer mb-3 ps-0">
          ...
          <div>
            ...
            />
            <label className="form-check-label" htmlFor="postPosted">
              {t("msg49")}
            </label>
          </div>
          <div>
            ...
            />
            <label className="form-check-label" htmlFor="assignmentAssigned">
              {t("msg48")}
            </label>
          </div>
          <div>
            ...
            />
            <label className="form-check-label" htmlFor="testAssigned">
              {t("msg47")}
            </label>
          </div>
          <div>
            ...
            />
            <label className="form-check-label" htmlFor="submissionGraded">
              {t("msg46")}
            </label>
          </div>
        </fieldset>
