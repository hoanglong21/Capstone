...
const ChangePassword = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      if (!currentPass) {
        ...
        !(await UserService.checkMatchPassword(userInfo.username, currentPass))
          .data
      ) {
  ...
  return (
    <div className="settings-css">
      <h4 className="settings-h4">{t('changeP')}</h4>
      <form className="mt-5 needs-validation" noValidate>
        ...
        <div className="form-group mb-3">
          <label className={FormStyles.formLabel}>{t('current')} {t('password')}</label>
          <input
            id="currentPass"
            name="currentPass"
            type="password"
        ...
        <div className="form-group mb-3">
          <label className={FormStyles.formLabel}>{t('new')} {t('password')}</label>
          <input
            id="newPass"
            name="newPass"
            type="password"
        ...
        <div className="form-group mb-3">
          <label className={FormStyles.formLabel}>{t('confirm')} {t('password')}</label>
          <input
            id="confirmPass"
            name="confirmPass"
            type="password"
