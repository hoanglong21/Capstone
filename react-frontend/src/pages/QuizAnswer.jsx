...
Nhà nước là yếu tố cơ bản trong kiến trúc thượng tầng của xã hội, nó:"
                  ...
                  >
                    <div style={{ display: "block" }}>
                      77) Chọn câu trả lời đúng nhất theo quan điểm của chủ
                      nghĩa duy vật lịch sử
                      <br />
                      Nhà nước là yếu tố cơ bản trong kiến trúc thượng tầng của
                      xã hội, nó:
                    </div>
                  </div>
                </div>
                  ...
                  >
                    <div class="c1sj1twu">
                      <div
                        ...
                        class="FormattedText notranslate FormattedTextWithImage-wrapper lang-vi"
                      >
                        Không có tác dụng gì tới cơ sở hạ tầng kinh tế mà chỉ có
                        tác dụng tới các yếu tố khác trong bản thân hệ thống
