    ...
    <div className="feedbackContainer">
      ...
      <form>
        <div className="row input-container" style={{ margin: "0 auto" }}>
          ...
          <h7 for="type">Choose your type feedback: </h7>
            <div className="styled-input wide">
              <select className="feedback__input" id="type">
                ...
                <option value="Infringes Rights">Infringes Rights</option>
                <option value="Caption Issue">Caption Issue</option>
          ...
          <div className="col-xs-12">
            <div className="styled-input wide">
              <input className="feedback__input" type="text" required />
              <label>Name</label>
            </div>
          </div>
          ...
          <div className="col-xs-12">
            <div className="styled-input wide">
              <textarea className="feedback__textarea" required></textarea>
              <label>Content</label>
            </div>
          </div>
          <div className="col-xs-12">
            <button className="btn-lrg send-submit-btn">Send Feedback</button>
          </div>
        </div>
      </form>
    </div>
