...
const Flashcard = () => {
  ...
  const handleEndReset = (index) => {
    ...
    setAudio(progress?.audio || "");
    setNote(progress?.note || "");
    document.querySelector("#flashcardAnimation .confetti-container")?.remove();
  };
  ...
  const handleSaveProgress = async () => {
    ...
    try {
      ...
      tempProgress = (await ProgressService.customUpdateProgress(tempProgress))
        .data;
      var tempCards = [...cards];
      tempCards[cardIndex].progress = tempProgress;
      setCards(tempCards);
    ...
    <div>
        ...
        <div className="d-flex align-items-center">
          ...
          <div className="flashcardMode dropdown d-flex align-items-center">
            <button
              ...
              aria-expanded="false"
            >
              <span className="ps-2 me-2">{t('flashcard')}</span>
              ...
              <li>
                ...
                >
                  <TestSolidIcon
                    ...
                    size="1.3rem"
                  />
                  <span className="align-middle fw-semibold">{t('quiz')}</span>
                </button>
              </li>
              <li>
      ...
      <div className="flashcardProgressContainer">
        <div
          ...
          style={{
            width: `${
              ((isEnd ? cards?.length : cardIndex) / cards?.length) * 100
            }%`,
          }}
        ></div>
      </div>
      {loading ? (
        ...
        <div className="flashcardMain mx-auto mb-5">
          ...
          <div className="d-flex align-items-center justify-content-between mt-4">
              ...
              {isAuto ? (
                <button
                  ...
                  onClick={() => {
                    ...
                    setTimeout(function () {
                      document.getElementById("autoPlayToastClose").click();
                    }, 2000);
                  }}
                >
            ...
            <div className="flashcardPlay">
              <button className="flashcardPlay_btn" onClick={handleShuffle}>
