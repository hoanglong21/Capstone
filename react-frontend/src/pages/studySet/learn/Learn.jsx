...
const Learn = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // fields
        var tempFields = (
          await FieldService.getFieldsByStudySetTypeId(tempStudySet.studySetType.id)
        ).data;
  ...
  const handleChangeQuestionType = (event) => {
    ...
    if (event.target.checked) {
      ...
      tempQuestionsTypes = tempQuestionsTypes.filter((item) => item !== value);
    }
  ...
  const handleCreateLearn = async () => {
    ...
    if (optionQuestionTypes.includes(1)) {
      if (optionWrittenPromptWith?.length < 1) {
        setError("You must select at least one side for your written prompt.");
        return;
      }
  ...
  const handleChangeProgressStatus = (event) => {
    ...
    if (event.target.checked) {
      ...
      tempProgressStatus = tempProgressStatus.filter((item) => item != value);
    }
    setOptionProgressStatus(tempProgressStatus);
  };
              ...
              <li>
                ...
                >
                  <StudySetSolidIcon
                    ...
                    size="1.3rem"
                  />
                  <span className="align-middle fw-semibold">Flashcards</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  <TestSolidIcon
                    ...
                    strokeWidth="2"
                  />
                  <span className="align-middle fw-semibold">Quiz</span>
                </button>
              </li>
              <li>
            ...
            <div id="learnAnimation">
              <div className="learnFinish mx-auto p-5">
                <div>
                  ...
                  <p>
                    Study again to practice the same questions or try another
                    study mode.
                  </p>
                ...
                <div className="learnEndProgress">
                  ...
                  <div className="progress-stacked">
                    <div
                      ...
                      aria-valuenow={(correct / questions.length) * 100}
                      aria-valuemin="0"
                      aria-valuemax="100"
                      style={{
                    ...
                    <div
                      ...
                      aria-valuenow={(incorrect / questions.length) * 100}
                      aria-valuemin="0"
                      aria-valuemax="100"
                      style={{
                        width: `${(incorrect / questions.length) * 100}%`,
                      }}
                    >
          ...
          <div className="modal-body">
                ...
                <div className="quizOptionBlock">
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      type="checkbox"
                      value={1}
                      checked={optionQuestionTypes?.includes(1) || ""}
                      id="written"
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      type="checkbox"
                      value={2}
                      checked={optionQuestionTypes?.includes(2) || ""}
                      id="mupltipleChoice"
                      onChange={handleChangeQuestionType}
                    />
                    <label
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      type="checkbox"
                      value={3}
                      checked={optionQuestionTypes?.includes(3) || ""}
                      id="trueFalse"
                      onChange={handleChangeQuestionType}
                    />
                ...
                <div className="quizOptionBlock">
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      onChange={() => {
                        setOptionShowPicture(!optionShowPicture);
                      }}
                    />
                ...
                <div className="quizOptionBlock">
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      onChange={() => {
                        setOptionShowAudio(!optionShowAudio);
                      }}
                    />
                ...
                <div className="quizOptionBlock">
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      id="note"
                      onChange={() => {
                        setOptionShowNote(!optionShowNote);
                      }}
                    />
                ...
                <div className="quizOptionBlock">
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      value="not studied"
                      checked={
                        optionProgressStatus?.includes("not studied") || ""
                      }
                      id="notStudied"
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      checked={
                        optionProgressStatus?.includes("still learning") || ""
                      }
                      id="stillLearning"
                      onChange={handleChangeProgressStatus}
                      disabled={
                        optionIsStar ? numStillStar == 0 : numStill == 0
                      }
                    />
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      type="checkbox"
                      value="mastered"
                      checked={optionProgressStatus?.includes("mastered") || ""}
                      id="mastered"
                      onChange={handleChangeProgressStatus}
                      disabled={
                        optionIsStar ? numMasterStar == 0 : numMaster == 0
                      }
                    />
                ...
                <div className="quizOptionBlock">
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      onChange={() => {
                        setOptionIsShuffle(!optionIsShuffle);
                      }}
                    />
            ...
            <ul className="nav nav-tabs mb-3" role="tablist">
              <li className="nav-item">
                <a
                  className={`nav-link quizOptionBlock_label ${
                    optionQuestionTypes?.includes(1) ? "" : "disabled"
                  }`}
                  aria-current="page"
                  id="listWrittenList"
                  data-bs-toggle="list"
              ...
              <li className="nav-item">
                <a
                  className={`nav-link quizOptionBlock_label ${
                    optionQuestionTypes?.includes(2) ? "" : "disabled"
                  }`}
                  id="listMultipleList"
                  data-bs-toggle="list"
                  href="#listMultiple"
              ...
              <li className="nav-item">
                <a
                  className={`nav-link quizOptionBlock_label ${
                    optionQuestionTypes?.includes(3) ? "" : "disabled"
                  }`}
            ...
            <div className="tab-content">
              ...
              <div
                className={`tab-pane fade ${
                  optionQuestionTypes?.includes(1) ? "" : "hide"
                }`}
                id="listWritten"
                role="tabpanel"
                        ...
                        <div className="mb-2" key={index}>
                          {type === 1 ? (
                            <input
                              ...
                              checked={
                                optionWrittenPromptWith === field.id || ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  setOptionWrittenPromptWith(field.id);
                                } else {
                                  setOptionWrittenPromptWith(0);
                                }
                              }}
                            />
                          ) : (
                            <input
                              ...
                              id={`writtenPromptWith${field.id}`}
                              checked={
                                optionWrittenPromptWith?.includes(field.id) ||
                                ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  ...
                                  tempWrittenPromptWith.push(field.id);
                      ...
                      {fields?.map((field, index) => (
                        <div className="mb-2" key={index}>
                          <input
                            ...
                            checked={optionWrittenAnswerWith === field.id || ""}
                            id={`writtenAnswerWith${field.id}`}
                            onChange={(event) => {
                              if (event.target.checked) {
                                setOptionWrittenAnswerWith(field.id);
                              } else {
                                setOptionWrittenAnswerWith(0);
                              }
                            }}
                          />
                          <label
              ...
              <div
                className={`tab-pane fade  ${
                  optionQuestionTypes?.includes(2) ? "" : "hide"
                }`}
                id="listMultiple"
                role="tabpanel"
                        ...
                        <div className="mb-2" key={index}>
                          {type === 1 ? (
                            <input
                              ...
                              checked={
                                optionMultiplePromptWith === field.id || ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  setOptionMultiplePromptWith(field.id);
                                } else {
                                  setOptionMultiplePromptWith(0);
                                }
                              }}
                            />
                          ) : (
                            <input
                              ...
                              id={`multiplePromptWith${field.id}`}
                              checked={
                                optionMultiplePromptWith?.includes(field.id) ||
                                ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  ...
                                  tempMultiplePromptWith.push(field.id);
                        ...
                        <div className="mb-2" key={index}>
                          {type === 1 ? (
                            <input
                              ...
                              checked={
                                optionMultipleAnswerWith === field.id || ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  setOptionMultipleAnswerWith(field.id);
                                } else {
                                  setOptionMultipleAnswerWith(0);
                                }
                              }}
                            />
                          ) : (
                            <input
                              ...
                              id={`multipleAnswerWith${field.id}`}
                              checked={
                                optionMultipleAnswerWith?.includes(field.id) ||
                                ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  ...
                                  tempMultipleAnswerWith.push(field.id);
              ...
              <div
                className={`tab-pane fade ${
                  optionQuestionTypes?.includes(3) ? "" : "hide"
                }`}
                id="listTrueFalse"
                role="tabpanel"
                        ...
                        <div className="mb-2" key={index}>
                          {type === 1 ? (
                            <input
                              ...
                              checked={
                                optionTrueFalsePromptWith === field.id || ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  setOptionTrueFalsePromptWith(field.id);
                                } else {
                                  setOptionTrueFalsePromptWith(0);
                                }
                              }}
                            />
                          ) : (
                            <input
                              ...
                              id={`trueFalsePromptWith${field.id}`}
                              checked={
                                optionTrueFalsePromptWith?.includes(field.id) ||
                                ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  ...
                                  tempTrueFalsePromptWith.push(field.id);
                        ...
                        <div className="mb-2" key={index}>
                          {type === 1 ? (
                            <input
                              ...
                              checked={
                                optionTrueFalseAnswerWith === field.id || ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  setOptionTrueFalseAnswerWith(field.id);
                                } else {
                                  setOptionTrueFalseAnswerWith(0);
                                }
                              }}
                            />
                          ) : (
                            <input
                              ...
                              id={`trueFalseAnswerWith${field.id}`}
                              checked={
                                optionTrueFalseAnswerWith?.includes(field.id) ||
                                ""
                              }
                              onChange={(event) => {
                                if (event.target.checked) {
                                  ...
                                  tempTrueFalseAnswerWith.push(field.id);
