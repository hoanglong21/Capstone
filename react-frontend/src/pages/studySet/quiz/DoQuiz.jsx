...
const DoQuiz = () => {
  ...
  useEffect(() => {
    if (!loading && isAllow) {
      ...
      document.getElementById("quizProgressContainer").style.top = headerHeight;
    }
  }, [loading, isAllow]);
      ...
      >
        <div className="d-flex align-items-center">
          ...
          <div className="quizMode dropdown d-flex align-items-center">
            ...
            <ul className="dropdown-menu" style={{ zIndex: "100000" }}>
              <li>
                <button
                ...
                >
                  <StudySetSolidIcon
                    ...
                    size="1.3rem"
                  />
                  <span className="align-middle fw-semibold">{t('flashcard')}</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  <LearnSolidIcon
                    ...
                    strokeWidth="2"
                  />
                  <span className="align-middle fw-semibold">{t('learn')}</span>
                </button>
              </li>
              <li>
              ...
              <li>
                <button
                  ...
                  type="button"
                >
                  <span className="align-middle fw-semibold">{t('home')}</span>
                </button>
              </li>
            </ul>
          </div>
                ...
                <div className="quizOptionBlock mb-4">
                  ...
                  <div className="mb-2 d-flex align-items-center">
                    <input
                      ...
                      value={optionNumQues}
                      onChange={(event) => {
                        setOptionNumQues(event.target.value);
                      }}
                    />
