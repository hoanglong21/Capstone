                    ...
                    {isEnd ? (
                        ...
                        >
                            <div
                                ...
                                aria-valuenow={`${((correct / numQues) * 100).toFixed(2)}`}
                                aria-valuemin="0"
                                aria-valuemax="100"
                                style={{
                                    width: `${((correct / numQues) * 100).toFixed(2)}%`,
                                }}
                            >
                            ...
                            <div
                                ...
                                aria-valuenow={`${((incorrect / numQues) * 100).toFixed(2)}`}
                                aria-valuemin="0"
                                aria-valuemax="100"
                                style={{
                                    width: `${((incorrect / numQues) * 100).toFixed(2)}%`,
                                }}
                            >
