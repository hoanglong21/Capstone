            ...
            {ques.answers.map((ans, ansIndex) => (
              <div key={ansIndex} className="col-12 mb-3">
                <div
                  ...
                  onClick={() => {
                    if (answers[quesIndex] === ans.card.id) {
                      handleChangeAnswer(null, quesIndex);
                      setProgress(progress > 0 ? progress - 1 : 0);
                    } else {
                      handleChangeAnswer(ans.card.id, quesIndex);
                      setProgress(progress + 1);
                    }
                  }}
                >
                  {ans.content.map((itemContent, index) => {
                    if (multipleAnswerWith === itemContent.field.id) {
                      return (
                        <div key={index} className="mb-2">
        ...
        <div className="card-body">
          ...
          <div className="row mb-4">
            <div className="col-6">
              <div className="quizQues_question--left h-100">
                {ques.question.content.map((itemContent, index) => {
                  if (trueFalsePromptWith === itemContent.field.id) {
                    return (
                      <div key={index} className="mb-2">
                        <div className="quizQues_label quizQues_label--sm mb-1">
                          {itemContent.field.name}
            ...
            <div className="col-6">
              <div className="quizQues_question--right h-100">
                {ques.answers[0].content.map((itemContent, index) => {
                  if (trueFalseAnswerWith === itemContent.field.id) {
                    return (
                      <div key={index} className="mb-2">
                        <div className="quizQues_label quizQues_label--sm mb-1">
                          {itemContent.field.name}
          ...
          <div className="row">
            <div className="col-6">
              <div
                className={`quizQues_answer ${
                  answers[quesIndex] === 1 && results[quesIndex] === 0
                    ? "incorrect"
                    : answers[quesIndex] === 1 && results[quesIndex] === 1
                    ? "correct"
                    : answers[quesIndex] === 1
                    ? "active"
                    : ""
            ...
            <div className="col-6">
              <div
                className={`quizQues_answer ${
                  answers[quesIndex] === 0 && results[quesIndex] === 0
                    ? "incorrect"
                    : answers[quesIndex] === 0 && results[quesIndex] === 1
                    ? "correct"
                    : answers[quesIndex] === 0
                    ? "active"
                    : ""
