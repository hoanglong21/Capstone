...
<section class="chatbox-popup">
  <header class="chatbox-popup__header">
    ...
    <aside style={{flex:'1'}}>
      <button class="chatbox-maximize"><i class="bi bi-window fs-3" aria-hidden="true"></i></button>
    </aside>
  </header>
...
<section class="chatbox-panel">
  <header class="chatbox-panel__header">
    ...
    <aside style={{flex:'3',textAlign: 'right'}}>
      <button class="chatbox-minimize"><i class="bi bi-window-stack fs-5" aria-hidden="true"></i></button>
      <button class="chatbox-panel-close"><i class="bi bi-x-lg fs-5" aria-hidden="true"></i></button>
    </aside>
  </header>
