    ...
    <div className="container">
      <div className="row useaccount mt-4">
        ...
        <ul className="useaccount-ul">
          ...
          <li>
            On the Register page, user need fill all information display on the
            screen to create.
          </li>
          <li>All information is validated and user must follow.</li>
          <li>
            After fill, please click on <strong>"Register"</strong> button after
            that the screen show message "Registered successfully. Please Login
            to continue."
          </li>
        </ul>
        </div>
      ...
      <div>
        ...
        <ul className="useaccount-ul">
          <li>
            On Header bar, when user click to icon avatar, pop-up settings will
            display. User choose <strong>"Settings"</strong> on the screen.
          </li>
      ...
      <div className="useaccount">
        <h4>Create Class?</h4>
        <ul className="useaccount-ul">
          <li>With Tutor access, user can create class in header sidebar with icon <strong>"+"</strong> button.</li>
          <li>
