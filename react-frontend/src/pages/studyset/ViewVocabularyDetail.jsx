        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-4" id="viewVocabModalLabel">
                友達
              </h1>
              <button
                type="button"
              ...
              <div id="word-detail-overview">
                <p>
                  <span id="txtKanji" data-kanji="友達">
                    <u class="furigana_text japan-font">友達</u>
                  </span>
                  ...
                  <li>
                    ...
                    <ul className="ul-disc">
                      <li>
                        ...
                        <p>
                          Việc trở thành bạn với người nước ngoài thật thú vị.
                        </p>
                      </li>
                      <li>
                        <u className="furigana_text japan-font">
                        ...
                        <p>Anh ấy có bạn bè trên khắp thế giới.</p>
                      </li>
                      <li>
                        <u className="furigana_text japan-font">
                          悲しい時は友達が励ましてくれる。
                        </u>
                        <p>Khi tôi buồn bạn bè đã an ủi tôi.</p>
                      </li>
                    </ul>
                  </li>
                </ol>
