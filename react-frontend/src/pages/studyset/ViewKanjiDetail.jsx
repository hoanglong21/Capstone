                  ...
                  <div className="kanji-search-detail">
                    <div className="kanji-search-block ed"
                      ...
                      <ul className="kanji-search-ul japan-font">
                        <li>
                          <span original-title="NHÂM">姙</span>
                        </li>
                        <li>
                          <span original-title="NỮ">女</span>
                          <span original-title="NHIỆM">任</span>
                        </li>
                        <li>
                          <span original-title="NỮ">女</span>
                          <span original-title="NHÂN ĐỨNG">亻</span>
                          <span original-title="NHÂM">壬</span>
                        </li>
                        <li>
                          <span original-title="NỮ">女</span>
                          <span original-title="NHÂN ĐỨNG">亻</span>
                          <span original-title="PHIỆT">丿</span>
                          <span original-title="SĨ">士</span>
                        </li>
                      </ul>
                    </div>
                    <div className="kanji-search-block ed"
