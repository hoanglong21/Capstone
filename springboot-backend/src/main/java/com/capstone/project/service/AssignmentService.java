...
//    Assignment updateAssignment(int id, Assignment assignment, List<String> file_names, int type, List<String> urls, List<String> file_types) throws ResourceNotFroundException;
    ...
    Map<String, Object> getFilterAssignment(String search, String author, String from, String to, String direction, int classid, int page, int size) throws ResourceNotFroundException;
}
