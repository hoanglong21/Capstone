...
public class UserStatisticServiceImpl implements UserStatisticService {
    ...
    @Override
    public List<List<Map<String, Object>>> getAccessStatistic(int id) throws ResourceNotFroundException {
        ...
        List<List<Map<String, Object>>> dividedResult = new ArrayList<>();
    ...
    public List<Integer> getClassJoinedStatistic(int id) throws ResourceNotFroundException, ParseException {
        ...
        List<String> listDate = dateRangePicker.getDateRange();
        for(int i=0; i<listDate.size()-1; i++) {
            Map<String, Object> response = classLearnerService.filterClassLearner(id, 0, listDate.get(i), listDate.get(i+1),"enrolled",
