...
public class QuestionTest {
    ...
    @CsvSource({
            "1,1,2, Who kill Jack Robin,question1.jpg, question1.mp3, question1.mp4, 5 ",
            "2,2,3, Who is the first president, question2.jpg, question2.mp3, question2.mp4, 1"
    })
    public void testQuestion(int testId,int typeId, int num_choice,String content,String picture,String audio, String video,int point){
