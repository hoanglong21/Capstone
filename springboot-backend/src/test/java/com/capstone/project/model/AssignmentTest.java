...
public class AssignmentTest {
    ...
    public void testAssignment(int userId,int classId, String created_date,String instruction,String due_date,String modified_date,String start_date,String title){
             try{
